...
import { ArrowLeft, LayoutDashboard, Users, Package, Shield, LogOut, BarChart3, ChevronLeft, ChevronRight, FileText, Search, Activity, History , Crown } from 'lucide-react';
    ...
    <>
      ...
      <div style={{ display: 'flex', minHeight: '100vh', background: '#050505' }}>
        {user?.role === 'SUPER_ADMIN' ? (
          <SuperAdminSidebar active="audit" />
        ) : (
          <AdminSidebar />
        )}
