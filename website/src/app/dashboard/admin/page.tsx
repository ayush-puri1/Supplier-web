...
export default function AdminDashboard() {
  ...
  return (
    <>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Newsreader:ital,opsz,wght@0,6..96,400..900;1,6..96,400..900&family=Syne:wght@400;600;700;800;900&family=DM+Sans:ital,opsz,wght@0,9..40,300;0,9..40,400;0,9..40,500;0,9..40,600;1,9..40,400&display=swap');
        ...
        *,*::before,*::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .action-btn { background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); color: rgba(255,255,255,0.7); cursor: pointer; padding: 6px 12px; border-radius: 8px; font-family: var(--font-heading); font-size: 11px; font-weight: 700; transition: all 0.2s; }
      ...
      <div style={{ display: 'flex', minHeight: '100vh', background: '#050505' }}>
        {user?.role === "SUPER_ADMIN" ? <SuperAdminSidebar active="admin_home" /> : <AdminSidebar />}

        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0, overflow: 'hidden' }}>
          {/* HEADER */}
          <header style={{ height: 54, background: '#050505', flexShrink: 0, borderBottom: '1px solid rgba(255,255,255,0.05)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 32px', gap: 16 }}>
             {/* CENTERED ADMIN TEXT */}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
              <Link href="/dashboard/admin/analytics" style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '7px 14px', borderRadius: 8, background: 'rgba(37,99,235,0.1)', border: '1px solid rgba(37,99,235,0.2)', color: '#60A5FA', textDecoration: 'none', fontFamily: "var(--font-heading)", fontSize: 11, fontWeight: 700, transition: 'all 0.2s' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
              ...
              <div style={{ background: '#1E1E1E', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 14, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
                <div style={{ padding: '16px 20px', borderBottom: '1px solid rgba(255,255,255,0.05)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  ...
                  <Link href="/dashboard/admin/suppliers" style={{ fontFamily: "var(--font-heading)", fontSize: 11, fontWeight: 700, color: '#3B82F6', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 4 }}>
              ...
              <div style={{ background: '#1E1E1E', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 14, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
                <div style={{ padding: '16px 20px', borderBottom: '1px solid rgba(255,255,255,0.05)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  ...
                  <Link href="/dashboard/admin/products" style={{ fontFamily: "var(--font-heading)", fontSize: 11, fontWeight: 700, color: '#3B82F6', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 4 }}>
                    View All <ArrowRight size={12} />
                  </Link>
                </div>
