...
export class AdminController {
    ...
    async getSuppliers(status, pagination) {
        return this.adminService.findAllSuppliers(status, pagination?.skip || 0, pagination?.take || 20);
    }
    ...
    async getPendingSuppliers(pagination) {
        return this.adminService.getPendingSuppliers(pagination?.skip || 0, pagination?.take || 20);
    }
    ...
    async getAllProducts(status, pagination) {
        return this.adminService.getAllProducts(status, pagination?.skip || 0, pagination?.take || 20);
    }
    ...
    async getAllUsers(pagination) {
        return this.adminService.findAllUsers(pagination?.skip || 0, pagination?.take || 20);
    }
    ...
    async getActiveSessions(pagination) {
        return this.sessionService.getAllSessionsForAdmin(pagination?.skip || 0, pagination?.take || 20);
    }
